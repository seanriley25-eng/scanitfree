...
export const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    desc: "Get instant AI feedback with ATS keyword match, JD comparison, scoring, and actionable suggestions",
    icon: "📄",
    category: "Career",
    status: "live",
    ...
    seoTitle: "Free AI Resume Reviewer — ATS Keyword Match & Instant Score",
    seoDesc:
  ...
  },
  {
    ...
    desc: "Paste your lease, select your state, and get jurisdiction-aware AI analysis of red flags and tenant rights",
    icon: "🔍",
    category: "Legal",
    status: "live",
    ...
    seoTitle: "Free AI Lease Scanner — State-Specific Red Flag Analysis",
    seoDesc:
      "Paste your lease and select your state for jurisdiction-aware AI analysis. Identifies unfair clauses, hidden fees, and red flags with state tenant law citations. Free, no signup.",
  },
  {
    id: "cover-letter",
