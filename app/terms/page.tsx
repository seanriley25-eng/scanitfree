  ...
  return (
    <div className="max-w-[640px] mx-auto px-6 py-16">
      ...
      <div className="text-muted text-sm leading-relaxed space-y-4">
        <p>
          These Terms of Service (&ldquo;Terms&rdquo;) govern your access to and use of scanitfree.com (the &ldquo;Site&rdquo;) and its tools (the &ldquo;Services&rdquo;), operated by Farallone Media LLC (&ldquo;we,&rdquo; &ldquo;our,&rdquo; or &ldquo;us&rdquo;). By accessing or using the Site, you agree to be bound by these Terms. If you do not agree, do not use the Site.
        </p>
        ...
        <p>The Site, including its design, code, text, graphics, logos, and other content (excluding User Inputs and AI-generated output based on User Inputs), is owned by Farallone Media LLC or its licensors and is protected by copyright, trademark, and other intellectual property laws.</p>
        ...
        <p className="uppercase">
          To the fullest extent permitted by law, Farallone Media LLC, its owners, employees, agents, and affiliates shall not be liable for any indirect, incidental, special, consequential, exemplary, or punitive damages, including but not limited to loss of profits, revenue, data, goodwill, or other intangible losses, arising from: your use of or inability to use the Services, any reliance on output generated by the Services, any unauthorized access to or alteration of your inputs, any third-party conduct or content on the Services, or any other matter relating to the Services.
        </p>
        <p className="uppercase">
        ...
        <p>You agree to indemnify, defend, and hold harmless Farallone Media LLC, its owners, employees, agents, and affiliates from any claim, demand, loss, liability, damage, or expense (including reasonable attorneys&apos; fees) arising out of or related to:</p>
        <ul className="list-disc pl-5 space-y-1">
        ...
        <p>These Terms are governed by the laws of the State of California, USA, without regard to conflict of law principles. Any dispute arising out of or relating to these Terms or the Services shall be resolved exclusively in the state or federal courts located in California, and you consent to the personal jurisdiction of those courts.</p>
        ...
        <p>These Terms, together with the Privacy Policy, constitute the entire agreement between you and Farallone Media LLC regarding the Services and supersede all prior or contemporaneous agreements, understandings, or representations.</p>
